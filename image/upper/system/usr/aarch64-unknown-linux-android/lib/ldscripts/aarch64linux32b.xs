...
ENTRY(_start)
SEARCH_DIR("/system/usr/usr/aarch64-unknown-linux-android/libilp32"); SEARCH_DIR("/system/usr/usr/libilp32"); SEARCH_DIR("/usr/local/libilp32"); SEARCH_DIR("/libilp32"); SEARCH_DIR("/usr/libilp32"); SEARCH_DIR("/system/usr/usr/aarch64-unknown-linux-android/lib"); SEARCH_DIR("/system/usr/usr/lib"); SEARCH_DIR("/usr/local/lib"); SEARCH_DIR("/lib"); SEARCH_DIR("/usr/lib");
SECTIONS
{
