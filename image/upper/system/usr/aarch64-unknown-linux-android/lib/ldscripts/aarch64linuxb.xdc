...
OUTPUT_ARCH(aarch64)
ENTRY(_start)
SEARCH_DIR("/system/usr/usr/aarch64-unknown-linux-android/lib64"); SEARCH_DIR("/system/usr/usr/lib64"); SEARCH_DIR("/usr/local/lib64"); SEARCH_DIR("/lib64"); SEARCH_DIR("/usr/lib64"); SEARCH_DIR("/system/usr/usr/aarch64-unknown-linux-android/lib"); SEARCH_DIR("/system/usr/usr/lib"); SEARCH_DIR("/usr/local/lib"); SEARCH_DIR("/lib"); SEARCH_DIR("/usr/lib");
SECTIONS
{
