...
ENTRY(_start)
SEARCH_DIR("/system/usr/aarch64-linux-android/libilp32"); SEARCH_DIR("/system/usr/libilp32"); SEARCH_DIR("/usr/local/libilp32"); SEARCH_DIR("/libilp32"); SEARCH_DIR("/usr/libilp32"); SEARCH_DIR("/system/usr/aarch64-linux-android/lib"); SEARCH_DIR("/system/usr/lib"); SEARCH_DIR("/usr/local/lib"); SEARCH_DIR("/lib"); SEARCH_DIR("/usr/lib");
SECTIONS
{
